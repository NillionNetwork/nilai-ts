...
export const DelegationServerConfigSchema = z.object({
  ...
  token_max_uses: z.number().positive().optional(),
});
export type DelegationServerConfig = z.infer<typeof DelegationServerConfigSchema>;

export const DelegationTokenRequestSchema = z.object({
  type: RequestTypeSchema.default(RequestType.DELEGATION_TOKEN_REQUEST),
  public_key: z.string(),
});
export type DelegationTokenRequest = z.infer<typeof DelegationTokenRequestSchema>;
...
export type DelegationTokenResponse = z.infer<typeof DelegationTokenResponseSchema>;

export const NilaiClientOptionsSchema = z.object({
  auth_type: AuthTypeSchema.default(AuthType.DELEGATION_TOKEN).optional(),
  nilauth_instance: NilAuthInstanceSchema.default(NilAuthInstance.SANDBOX).optional(),
  nilauth_url: z.string().url().optional(),
...
export const DefaultDelegationTokenServerConfig: DelegationServerConfig = DelegationServerConfigSchema.parse({
